...
output_dir = r"/workspaces/bace-bureaucrats/app/bace/"
...
table_name = 'bace-bureaucrats-db' # Update this if the name of the database TableName in template.yaml is changed
...
windows = [
    ...
    (None, 10,   "PMC_reestimation_q1_10",  "reestimation_q1_10.csv"),
    (10,   20,   "PMC_reestimation_q11_20", "reestimation_q11_20.csv"),
    (None, None, "PMC_reestimation_q1_20",  "reestimation_q1_20.csv"),
]
